class Norma < ActiveRecord::Base
  ...
  has_many :relationship_prorroga_suspencion, class_name: 'ProrrogaSuspencionRelationship', foreign_key: 'me_suspende_id'
  has_many :prorroga_suspencion, through: :relationship_prorroga_suspencion, source: :suspendida
  has_many :relationship_me_prorrogan_suspencion, class_name: 'ProrrogaSuspencionRelationship', foreign_key: 'suspendida_id'
