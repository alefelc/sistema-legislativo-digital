module EspecialsHelper
  ...
  def search_value_classify_esp(id_clasif, id_norm)
    Especial.find(id_norm).clasificacions.where(nombre: id_clasif).present? unless id_norm.nil?
  end
end
