module OtraNormasHelper
  ...
  def search_value_classify_otra(id_clasif, id_norm)
    OtraNorma.find(id_norm).clasificacions.where(nombre: id_clasif).present? unless id_norm.nil?
  end
