module ResolucionsHelper
  ...
  def search_value_classify_resol(id_clasif, id_norm)
    Resolucion.find(id_norm).clasificacions.where(nombre: id_clasif).present? unless id_norm.nil?
  end
