class EspecialDatatable < AjaxDatatablesRails::Base
  ...
  def associated_file esp
    ...
    "<i class='btn btn-xs btn-danger fa fa-times remove-tr' data-remove='#{esp.id}' title='Borrar norma'></i>" +
    "<i class='linktoedit btn btn-xs btn-warning fa fa-pencil-square-o u' data-id='#{esp.id}' title='Editar norma'></i>" +
